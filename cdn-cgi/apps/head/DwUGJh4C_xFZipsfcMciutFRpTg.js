;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="80ddacdddccffda990ed068012da4dc1";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["Wu8l7FBLbwpk"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["Wu8l7FBLbwpk"].options={"account":{"accountId":"x90FdwHaHnVA","service":"googleanalytics","userId":"114791633398126895789"},"anonymizeIp":false,"id":"","organization":"148832942","social":true,"web-properties-for-148832942":"UA-148832942-1","webPropertySchemaNames":["web-properties-for-148832942"]};;if(CloudflareApps.matchPage(CloudflareApps.installs['Wu8l7FBLbwpk'].URLPatterns)){(function(){var options=CloudflareApps.installs['Wu8l7FBLbwpk'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("Wu8l7FBLbwpk"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
